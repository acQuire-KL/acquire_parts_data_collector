...
ENRICHED_PARTS_COLUMNS = [
    ...
    _column("Provider #1", "Provider Name", "Provider commercial profile", "Provider with useful returned data occupying dashboard position 1", key="Provider #1 Name"),
    _column("Provider #1", "Available", "Provider commercial profile", "Availability snapshot", key="Provider #1 Available"),
    _column("Provider #1", "Lead Time (Weeks)", "Provider commercial profile", "Manufacturer lead time reported by the provider", key="Provider #1 Lead Time"),
    _column("Provider #1", "Currency", "Provider commercial profile", "Currency applying to the provider price ladder", key="Provider #1 Currency"),
    _column("Provider #1", "Price Breaks", "Provider commercial profile", "Price ladders; detailed offers remain in Commercial Analysis", key="Provider #1 Price Breaks"),

    _column("Provider #2", "Provider Name", "Provider commercial profile", "Provider with useful returned data occupying dashboard position 2", key="Provider #2 Name"),
    _column("Provider #2", "Available", "Provider commercial profile", "Availability snapshot", key="Provider #2 Available"),
    _column("Provider #2", "Lead Time (Weeks)", "Provider commercial profile", "Manufacturer lead time reported by the provider", key="Provider #2 Lead Time"),
    _column("Provider #2", "Currency", "Provider commercial profile", "Currency applying to the provider price ladder", key="Provider #2 Currency"),
    _column("Provider #2", "Price Breaks", "Provider commercial profile", "Price ladders; detailed offers remain in Commercial Analysis", key="Provider #2 Price Breaks"),

    _column("Provider #3", "Provider Name", "Provider commercial profile", "Provider with useful returned data occupying dashboard position 3", key="Provider #3 Name"),
    _column("Provider #3", "Available", "Provider commercial profile", "Availability snapshot", key="Provider #3 Available"),
    _column("Provider #3", "Lead Time (Weeks)", "Provider commercial profile", "Manufacturer lead time reported by the provider", key="Provider #3 Lead Time"),
    _column("Provider #3", "Currency", "Provider commercial profile", "Currency applying to the provider price ladder", key="Provider #3 Currency"),
    _column("Provider #3", "Price Breaks", "Provider commercial profile", "Price ladders; detailed offers remain in Commercial Analysis", key="Provider #3 Price Breaks"),
